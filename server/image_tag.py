...
def write(jsonresponse):
    ...
    with open('t.json') as read_file:
        ...
        y={c_time:[image_path,jsonresponse['result']["tags"][0]['tag']["en"]+" "+jsonresponse['result']["tags"][1]['tag']["en"]]}
...
if(findtag(image_path,c_time)!=None):
    ...
    print(jsonresponse['result']["tags"][0]['tag']["en"]+" "+jsonresponse['result']["tags"][1]['tag']["en"])
    write(jsonresponse)
